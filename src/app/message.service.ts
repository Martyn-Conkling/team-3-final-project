  ...
  pushMessage(
    ...
    setLocalStorageData2Array(){
      ...
      if(localStorage.getItem('general') != null){
        ...
        this.general = general ? JSON.parse(general) : null;
      ...
      if(localStorage.getItem('marketing') != null){
        ...
        this.marketing = marketing ? JSON.parse(marketing) : null; 
      ...
      if(localStorage.getItem('random') != null) {
        ...
        this.random = random ? JSON.parse(random) : null;
      ...
      if(localStorage.getItem('internalProjects') != null){
        ...
        const internalProjects = localStorage.getItem('internalProjects');
        this.internalProjects = internalProjects ? JSON.parse(internalProjects) : null;
      }

      if(localStorage.getItem('client') != null){
        //this.client = JSON.parse(localStorage.getItem('client'));
        const client = localStorage.getItem('client');
        this.client = client ? JSON.parse(client) : null;
      }
